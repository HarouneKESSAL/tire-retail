...
@section('main-content')
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-danger float-left">Liste des Utilisateurs</h6>
            <a href="{{route('users.create')}}" class="btn btn-danger btn-sm float-right" data-toggle="tooltip" data-placement="bottom" title="Ajouter un utilisateur"><i class="fas fa-plus"></i> Ajouter un Utilisateur</a>
        </div>
        <div class="card-body">
            <div class="table-responsive">
                ...
                <span style="float:right">{{$users->links('vendor.pagination.custom-pagination')}}</span>
            </div>
        </div>
    </div>
@endsection
