...
@section('main-content')
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-danger float-left">Liste des Bannières</h6>
            <a href="{{route('banner.create')}}" class="btn btn-danger btn-sm float-right" data-toggle="tooltip" data-placement="bottom" title="Ajouter une Bannière"><i class="fas fa-plus"></i> Ajouter une Bannière</a>
        </div>
        <div class="card-body">
            <div class="table-responsive">
                @if(count($banners)>0)
                    ...
                    <span style="float:right">{{$banners->links('vendor.pagination.custom-pagination')}}</span>
