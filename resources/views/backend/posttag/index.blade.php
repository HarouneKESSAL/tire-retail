...
@section('main-content')
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-danger float-left">Liste des Étiquettes d'Articles</h6>
            <a href="{{route('post-tag.create')}}" class="btn btn-danger btn-sm float-right" data-toggle="tooltip" data-placement="bottom" title="Ajouter une Étiquette"><i class="fas fa-plus"></i> Ajouter une Étiquette</a>
        </div>
        <div class="card-body">
            <div class="table-responsive">
                @if(count($postTags)>0)
                    ...
                    <span style="float:right">{{$postTags->links('vendor.pagination.custom-pagination')}}</span>
                @else
                    <h6 class="text-center">Aucune étiquette trouvée !!! Veuillez créer une étiquette</h6>
                @endif
            </div>
        </div>
    </div>
