            ...
            <form method="post" action="{{route('product.update',$product->id)}}">
                ...
                <div class="form-group">
                    ...
                    <select name="size[]" class="form-control selectpicker" multiple data-live-search="true">
                        ...
                        @foreach(['S' => 'Small', 'M' => 'Medium', 'L' => 'Large', 'XL' => 'Extra Large'] as $size => $label)
                            <option value="{{ $size }}" {{ in_array($size, explode(',', $product->size)) ? 'selected' : '' }}>{{ $label }}</option>
                        @endforeach
                    </select>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input id="width" type="number" name="width" placeholder="Enter width" value="{{$product->width}}" class="form-control">
                    @error('width')
                    <span class="text-danger">{{$message}}</span>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <input id="aspect_ratio" type="number" name="aspect_ratio" placeholder="Enter aspect ratio" value="{{$product->aspect_ratio}}" class="form-control">
                    @error('aspect_ratio')
                    <span class="text-danger">{{$message}}</span>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <input id="diameter" type="number" name="diameter" placeholder="Enter diameter" value="{{$product->diameter}}" class="form-control">
                    @error('diameter')
                    <span class="text-danger">{{$message}}</span>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <div id="options-container">
                        @foreach($product->options as $index => $productOption)
                            <div class="option-row mb-3">
                                <select name="options[{{ $index }}][option_id]" class="form-control mb-2 option-select">
                                    @foreach($options as $option)
                                        <option value="{{ $option->id }}" data-type="{{ $option->type }}" {{ $productOption->id == $option->id ? 'selected' : '' }}>
                                            {{ $option->name }}
                                        </option>
                                    @endforeach
                                </select>
                                <input type="text" name="options[{{ $index }}][value]" class="form-control mb-2 option-value" placeholder="Enter Option Value" value="{{ $productOption->value }}">
                ...
                <div class="form-group">
                    ...
                    <select name="season" class="form-control">
                        ...
                        <option value="all-season" {{ $product->season == 'all-season' ? 'selected' : '' }}>All-Season</option>
