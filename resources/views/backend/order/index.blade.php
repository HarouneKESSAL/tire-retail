...
@section('main-content')
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-danger float-left">Liste des commandes</h6>
        </div>
        <div class="card-body">
            <div class="table-responsive">
                @if(count($orders)>0)
                    <table class="table table-bordered" id="order-dataTable" width="100%" cellspacing="0">
                        ...
                        @foreach($orders as $order)
                            ...
                            <tr>
                                ...
                                <td>@foreach($shipping_charge as $data) CAD {{number_format($data,2)}} @endforeach</td>
                    ...
                    <span style="float:right">{{$orders->links('vendor.pagination.custom-pagination')}}</span>
                @else
