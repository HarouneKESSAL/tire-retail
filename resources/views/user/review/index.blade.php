                    ...
                    <table class="table table-bordered" id="order-dataTable" width="100%" cellspacing="0">
                        ...
                        @foreach($reviews as $review)
                            <tr>
                                ...
                                <td>
                                    <a href="{{route('user.productreview.edit',$review->id)}}" class="btn btn-primary btn-sm float-left mr-1" style="height:30px; width:30px;border-radius:50%" data-toggle="tooltip" title="Modifier" data-placement="bottom"><i class="fas fa-edit"></i></a>
