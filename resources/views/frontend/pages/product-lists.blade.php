				...
				<div class="row">
					<div class="col-12">
						<div class="bread-inner">
							<ul class="bread-list">
								<li><a href="{{route('homeIN')}}">Accueil<i class="ti-arrow-right"></i></a></li>
								<li class="active"><a href="javascript:void(0);">Boutique en Listes</a></li>
							</ul>
						</div>
					</div>
				</div>
						...
						<div class="col-lg-3 col-md-4 col-12">
							<div class="shop-sidebar">
                                ...
                                <div class="filter-sidebar">
                                    <!-- Search Filter Title -->
                                    <h3 class="filter-title">FILTRE DE RECHERCHE</h3>
