...
@section('main-content')
                    ...
                    <div class="col-lg-8 col-12">
                        <div class="form-main">
                            <div class="title">
                                ...
                                <h3>Écrivez-nous un message @auth @else<span style="font-size:12px;" class="text-danger">[Vous devez vous connecter d'abord]</span>@endauth</h3>
                            </div>
    ...
    <div class="map-section">
        <div id="myMap">
            <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d11583.930456353245!2d-79.3839345!3d43.653226!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x882b34d6b70b9df5%3A0x4c5a2cd7d76b2f7!2sToronto%2C%20ON%2C%20Canada!5e0!3m2!1sen!2sus!4v1595323330171!5m2!1sen!2sus" width="100%" height="100%" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
        </div>
    </div>
    ...
    <div class="modal fade" id="error" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p class="text-warning">Une erreur est survenue.</p>
                </div>
            </div>
        </div>
    </div>
